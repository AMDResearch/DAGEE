...
struct MemCopyTaskLaunchPolicy {
 ...
 protected:
  static ATMIcopyParam initCopyParam(const TaskInstance&) { return impl::initCopyParam(); }
...
using MemCopyExecutorAtmi = ExecutorSkeletonAtmi<NoKernelRegPolicy, MemCopyTaskLaunchPolicy>;
