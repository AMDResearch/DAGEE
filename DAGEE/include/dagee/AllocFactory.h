 ...
 *
 * Negatives:
 * 1. Static initialization. The AllocatorFactory is built on top of some heap, which is maintained as
 * static variables and statically initialized. Some Allocators may be multi-threaded so they have a
 * thread-local heap. Multi-threaded static initialization can have its pitfalls.  
 *
